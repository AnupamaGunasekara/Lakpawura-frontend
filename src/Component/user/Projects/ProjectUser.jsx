...
const items = [
  ...
  { key: "2", icon: <MessageOutlined />, label: "Contact Lakpawura" },
  {
    key: "sub1",
    label: "Categories",
    icon: <UnorderedListOutlined />,
    children: [
      { key: "5", label: "Upcoming" },
      { key: "6", label: "Completed" },
      { key: "7", label: "On Going" },
      { key: "8", label: "Top Rated" },
    ],
  },
  { key: "9", icon: <SettingOutlined />, label: "Account Settings" },
